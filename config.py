...
menu_icon = (
    'https://ropletef.sirv.com/cock.png', # image url
    'https://cookiezi.gay' # onclick url
)

# seasonal backgrounds to be displayed ingame.
seasonal_bgs = (
    'https://preview.redd.it/wbnn4jk6p9j31.jpg?auto=webp&s=ded67e7e83c8e226c5874774e4da83613ac090d2',
)
